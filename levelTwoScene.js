class levelTwoScene extends Scene {
    ...
    draw() {
            ...
            if (!this.player.crashed) {
                ...
                this.context.fillText( "You Win! Your Score Was " + (this.gameState.score + this.player.fuel).toFixed(0), this.context.canvas.width /2 - 300, 200);
    ...
    onLoad(){
        ...
        this.terrain = new TerrainGenerator(this.context, 1);
